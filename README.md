...
Clicking Optimize (widget ⚡, right-click menu, or the button in the full monitor):
...
| `optimize-history.csv` | One row per optimize: MB freed, processes trimmed, RAM % before/after, what was protected |
